...
use crate::integration::utils::{
    assert_no_receive, assert_receive, connected_client, disconnect, publish, subscribe,
};
...
async fn subscribe_retain_handling_default() {
    ...
    publish(&mut publisher, 0, TOPIC, MSG, QoS1, true, false, true).await;
...
async fn subscribe_retain_handling_clean_only() {
    ...
    subscribe(&mut receiver, TOPIC, QoS1, SendIfNotSubscribedBefore, false, false).await;
